...
data_soils_world = data_soils_world.rename(columns = {'gridcode': 'Value'})
...
data_soils_geoparks = data_soils_geoparks.rename(columns = {'gridcode': 'Value'})
...
#%% percentage not in geoparks 
        
#world
soils_compare_null_W = soils_world_compare.loc[soils_world_compare['percentage_in_geopark']==0]
nr_soils_not_in_geopark_W = len(soils_compare_null_W)
percentage_soils_not_in_geopark_W = nr_soils_not_in_geopark_W/len(soils_world_compare.soil_name.unique().tolist())*100

#continents
list_continent = soils_continents.continent.unique().tolist()

for continent in list_continent:
    
    list_soils_not_null  = soils_continents['soil_name'].loc[(soils_continents['area_km2']!=0) & (soils_continents['continent']==continent)].unique().tolist()
    total_soils_on_continent = len(list_soils_not_null)
    nr_soils_in_geopark_C = len(soils_continents_geoparks['soil_name'].loc[(soils_continents_geoparks['area_km2']!=0) & (soils_continents_geoparks['continent']==continent)].tolist())
    
    percentage_soils_not_in_geopark_C = 100-(nr_soils_in_geopark_C/total_soils_on_continent)*100
    
    print (continent + ': ' + str(total_soils_on_continent)+ ' unique types. '+str(nr_soils_in_geopark_C)+' unique types in geoparks. '+ str(percentage_soils_not_in_geopark_C)+ '% not in geoparks')
